            ...
            while($result=mysqli_fetch_assoc($res)){
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="course_register.php?courseid=<?php echo htmlentities($result['courseid']);?>"><button class="btn btn-primary">Register</button></a>    </td>
